...
module.exports = CoreObject.extend({
  changeTo: function(scenario){
    var manager = this;
    return RSVP.all([
      BowerHelpers.resetBowerFile(manager.project.root),
      NpmHelpers.resetNpmFile(manager.project.root)
    ]).then(function(){
      ...
      return RSVP.all([
        BowerHelpers.install(manager.project.root),
        NpmHelpers.install(manager.project.root)
      ]);
    }).then(function(){
